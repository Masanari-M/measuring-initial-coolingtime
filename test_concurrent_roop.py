# -*- coding: utf-8 -*-
"""
Created on Mon Oct 28 16:01:35 2024
...
class Camera():
    ...
    def SETTING(self):
        ...
        # #wx
        v_start= ion_pos[1]-10 # min 0
        v_end =  ion_pos[1]+10 # max 1024
        h_start= ion_pos[0]-50 # min 0
        h_end =  ion_pos[0]+50  # max 1280
