# -*- coding: utf-8 -*-
"""
Created on Mon Aug  5 19:24:03 2024
...
def main():
    ...
    with ProcessPoolExecutor(max_workers=2) as executor:
        futures = [executor.submit(task1, startTime), executor.submit(task2, startTime)]
...
def main():
    ...
    delay_sec_list = np.zeros(10)#np.linspace(0, 0.5, delay_times)
