...
# Timer Event
#----------------------------------------
TME_INT = 0x00000001            # Event that interval elapses
#----------------------------------------
# Analog Input Status
#----------------------------------------
...
# Timer Message
#----------------------------------------
AIOM_TME_INT = 0x1060           # Event that interval elapses
#----------------------------------------
...
#----------------------------------------
# Analog Input Transfer Size
#----------------------------------------
AI_TRANSFERSIZE_MANUAL = 0      # Analog input transfer size manual setting
AI_TRANSFERSIZE_AUTO = 1        # Analog input transfer size auto setting
#----------------------------------------
# Analog Output Transfer Size
#----------------------------------------
AO_TRANSFERSIZE_MANUAL = 0      # Analog output transfer size manual setting
AO_TRANSFERSIZE_AUTO = 1        # Analog output transfer size auto setting
...
# C Prototype: long WINAPI AioSetAiTransferSize(short Id, short AutoMode, long TransferSize);
AioSetAiTransferSize = caio_dll.AioSetAiTransferSize
AioSetAiTransferSize.restype = ctypes.c_long
AioSetAiTransferSize.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.c_long]

# C Prototype: long WINAPI AioGetAiTransferSize(short Id, short *AutoMode, long *TransferSize);
AioGetAiTransferSize = caio_dll.AioGetAiTransferSize
AioGetAiTransferSize.restype = ctypes.c_long
AioGetAiTransferSize.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.POINTER(ctypes.c_long)]
...
# C Prototype: long WINAPI AioSetAoTransferSize(short Id, short AutoMode, long TransferSize);
AioSetAoTransferSize = caio_dll.AioSetAoTransferSize
AioSetAoTransferSize.restype = ctypes.c_long
AioSetAoTransferSize.argtypes = [ctypes.c_short, ctypes.c_short, ctypes.c_long]

# C Prototype: long WINAPI AioGetAoTransferSize(short Id, short *AutoMode, long *TransferSize);
AioGetAoTransferSize = caio_dll.AioGetAoTransferSize
AioGetAoTransferSize.restype = ctypes.c_long
AioGetAoTransferSize.argtypes = [ctypes.c_short, ctypes.POINTER(ctypes.c_short), ctypes.POINTER(ctypes.c_long)]
